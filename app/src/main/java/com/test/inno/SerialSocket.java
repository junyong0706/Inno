...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_CCCD           = UUID.fromString("31a205b5-79e6-4e15-9381-9e009b5fa083");
...
//                System.out.println("writeBuffer.isEmpty()");
//                writePending = true;
//            } else {
...
//            }
//            if(data.length > payloadSize) {
//                System.out.println("(data.length+payloadSize-1)/payloadSize:"+(data.length+payloadSize-1)/payloadSize);
...
//        }
        if(data0 != null) {
            System.out.println("data0 is not null:"+data0);
            writeCharacteristic.setValue(data0);
            System.out.println("data0 is not null2:"+data0);
            if (!gatt.writeCharacteristic(writeCharacteristic)) {
                System.out.println("data0 is not null3:"+data0);
                onSerialIoError(new IOException("write failed"));
            } else {
                System.out.println("data0 is not null4:"+data0.length);
